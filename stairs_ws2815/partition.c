...
// Return flash XIP address of the alternate partition for OTA update
/**
 ...
 */
static int msg_printf(char **cursor, size_t *remaining, const char *fmt, ...) {
