...
static const struct pio_program can2040_program = {
    ...
    .length = 32,
    .origin = -1,
    .pio_version = can2040_pio_version,
...
#define sm_sync_setup_pio_version 1
...
static const struct pio_program sm_sync_setup_program = {
    ...
    .length = 2,
    .origin = -1,
    .pio_version = sm_sync_setup_pio_version,
#if PICO_PIO_VERSION > 0
    .used_gpio_ranges = 0x0
#endif
};
...
#define sm_sync_alt_slow_start_pio_version 1
...
static const struct pio_program sm_sync_alt_slow_start_program = {
    ...
    .length = 1,
    .origin = -1,
    .pio_version = sm_sync_alt_slow_start_pio_version,
#if PICO_PIO_VERSION > 0
    .used_gpio_ranges = 0x0
#endif
};
...
#define sm_rx_setup_pio_version 1
...
static const struct pio_program sm_rx_setup_program = {
    ...
    .length = 0,
    .origin = -1,
    .pio_version = sm_rx_setup_pio_version,
#if PICO_PIO_VERSION > 0
    .used_gpio_ranges = 0x0
#endif
};
...
#define sm_match_setup_pio_version 1
...
static const struct pio_program sm_match_setup_program = {
    ...
    .length = 3,
    .origin = -1,
    .pio_version = sm_match_setup_pio_version,
#if PICO_PIO_VERSION > 0
    .used_gpio_ranges = 0x0
#endif
};
...
#define sm_tx_setup_pio_version 1
...
static const struct pio_program sm_tx_setup_program = {
    ...
    .length = 2,
    .origin = -1,
    .pio_version = sm_tx_setup_pio_version,
#if PICO_PIO_VERSION > 0
    .used_gpio_ranges = 0x0
#endif
};
...
#define sm_tx_transmit_pio_version 1
...
static const struct pio_program sm_tx_transmit_program = {
    ...
    .length = 3,
    .origin = -1,
    .pio_version = sm_tx_transmit_pio_version,
#if PICO_PIO_VERSION > 0
    .used_gpio_ranges = 0x0
#endif
};
...
#define sm_tx_ack_pio_version 1
...
static const struct pio_program sm_tx_ack_program = {
    ...
    .length = 4,
    .origin = -1,
    .pio_version = sm_tx_ack_pio_version,
#if PICO_PIO_VERSION > 0
    .used_gpio_ranges = 0x0
#endif
};
...
#define reference_sync_sm_pio_version 1
...
static const struct pio_program reference_sync_sm_program = {
    ...
    .length = 22,
    .origin = -1,
    .pio_version = reference_sync_sm_pio_version,
#if PICO_PIO_VERSION > 0
    .used_gpio_ranges = 0x0
#endif
};
